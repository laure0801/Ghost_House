...
offer = Offer.create!(user: User.all.first, title: "Haunted mansion", description: "ça fait peur woulah", price: 50, address: "25 bouevard des champignons, 68422 Paris", disponibility: DateTime.new(2024/10/23))
offer.photos.attach(io: file, filename: 'nes.png', content_type: 'image/png')

offer2 = Offer.create!(user: User.all.first, title: "Haunted ", description: "ça fait peur ", price: 50, address: "25 bouevard des champignons, 68422 Metez", disponibility: DateTime.new(2024/10/23))
offer2.photos.attach(io: file2, filename: 'nes.png', content_type: 'image/png')

offer3 = Offer.create!(user: User.all.first, title: "Haunted hoclqjbv", description: "lohnzlbne", price: 50, address: "25 bouevard des cimetieres, 68422 Paris", disponibility: DateTime.new(2024/10/23))
